...
* 💻 Solved **1100+** programming problems
* 🌱 Currently specializing in **Spring Boot**, **Angular**, and **Software Engineering**
* 🤖 Working on AI-assisted Unit Test Generation for my graduation project
...
Developed a task management application twice:
- Vanilla JavaScript implementation to strengthen core JavaScript concepts.
- React implementation with reusable components and state management.
